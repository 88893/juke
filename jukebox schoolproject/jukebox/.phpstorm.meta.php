...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\kirof\Downloads\jukebox schoolproject\jukebox\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\kirof\\Downloads\\jukebox schoolproject\\jukebox\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'songs.index','songs.create','songs.store',
'songs.show','songs.edit','songs.update','songs.destroy','songs.statistics',
'reviews.store','reviews.destroy','plays.index','storage.local',);
        registerArgumentsSet('views', 
'layouts.app','plays.index','songs.create','songs.edit','songs.index',
'songs.show','songs.statistics','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
